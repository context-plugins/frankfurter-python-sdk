...
from frankfurterapi.exceptions.api_exception import (
    ApiException,
)
...
class UnprocessableEntityException(ApiException):
    def __init__(self, reason, response):
        """Initialize UnprocessableEntityException object.
        ...
        """
        super(UnprocessableEntityException, self).__init__(reason, response)
