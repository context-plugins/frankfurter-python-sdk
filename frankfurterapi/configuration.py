...
from frankfurterapi.http.proxy_settings import (
    ProxySettings,
)
from frankfurterapi.logging.configuration.api_logging_configuration import (
...
class Configuration(HttpClientConfiguration):
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: "https://api.frankfurter.dev/v2",
        },
    }
